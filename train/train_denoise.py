...
train_loader = DataLoader(dataset=train_dataset, batch_size=opt.batch_size, shuffle=True,  pin_memory=False, drop_last=False)
val_dataset = get_validation_data(opt.val_dir)
#val_loader = DataLoader(dataset=val_dataset, batch_size=opt.batch_size, shuffle=False,  num_workers=opt.eval_workers, pin_memory=False, drop_last=False)
val_loader = DataLoader(dataset=val_dataset, batch_size=opt.batch_size, shuffle=False,  pin_memory=False, drop_last=False)
